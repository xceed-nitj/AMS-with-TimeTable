...
router.get("/attendance-thresholds", ctrl.getAttendanceThresholds);
router.patch("/attendance-thresholds", ctrl.updateAttendanceThresholds);
...
router.get("/class-lookup", ctrl.classLookup);
router.get("/subjects-for-sem", ctrl.subjectsForSem);
router.get("/faculty-for-subject", ctrl.facultyForSubject);
router.post("/alteration", ctrl.addAlteration);
