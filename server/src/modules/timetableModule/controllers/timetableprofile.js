...
const addFacultyController = require("./addfacultyprofile");
const addFacultyInstance = new addFacultyController();
...
class TableController {
  ...
  async publishTimetable(req, res) {
    ...
    try {
      ...
      const allfaculties = await addFacultyInstance.getAddedFacultyByCode(updatedTimeTable.code);
      console.log("emailing started",allfaculties);
