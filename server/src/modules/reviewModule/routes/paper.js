...
const { findAllPapers, addReviewer, findEventPaper, findPaper, updatePaper, removeReviewer, findPaperByReviewer,findPaperByAuthor, addAuthor } = require("../controller/papers");
