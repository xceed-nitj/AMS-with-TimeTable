...
const { findAllPapers, addReviewer, findEventPaper, findPaper, updatePaper, removeReviewer,findPaperById, findPaperByReviewer ,addAuthor } = require("../controller/papers");
