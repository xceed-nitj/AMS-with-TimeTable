...
const ConferencePage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${apiUrl}/conf`, formData, {
            headers: {
                Authorization: ''
            }
        })
    ...
    const handleUpdate = () => {
        axios.put(`${apiUrl}/conf/${editID}`, formData, {
            headers: {
                Authorization: ''
            }
        })
    ...
    const handleDelete = (deleteID) => {
        axios.delete(`${apiUrl}/conf/${deleteID}`, {
            headers: {
                Authorization: ''
            }
        })
    ...
    const handleEdit = (editIDNotState) => {
        axios.get(`${apiUrl}/conf/${editIDNotState}`, {
            headers: {
                Authorization: ''
            }
        })
    ...
    return (
        <div className="tw-block box-border">
            <form className="tw-bg-blue-100 lg:tw-max-w-4xl lg:tw-mx-auto tw-shadow-md tw-rounded tw-px-8 tw-pt-6 tw-pb-8 tw-m-10" autoComplete="off" onSubmit={handleSubmit}>
                <div className="tw-text-blue-700 tw-text-[28px] tw-font-serif tw-mx-auto tw-my-auto tw-grid tw-place-content-center">Create a new Conference</div>
                ...
                <div className="tw-flex tw-justify-evenly">
                    <button type="submit" className="tw-bg-blue-500 hover:tw-bg-blue-700 tw-text-white tw-font-bold tw-py-2 tw-px-4 tw-rounded focus:tw-outline-none focus:tw-shadow-outline">Add Conference</button>
                    <button
                        type="submit"
                        onClick={() => {
                            handleUpdate();
            ...
            <div>
                <div className="tw-text-black tw-text-[28px] tw-font-serif tw-mx-auto tw-my-auto tw-grid tw-place-content-center">Existing Conferences</div>
                                        ...
                                        <Link to="/cmadp">
                                            <div className="tw-p-1 tw-text-center tw-flex tw-justify-evenly">
                                                <button
                                                    ...
                                                    className="tw-bg-yellow-500 hover:tw-bg-yellow-700 tw-text-white tw-font-bold tw-px-4 tw-rounded focus:tw-outline-none focus:tw-shadow-outline"
                                                >
                                                    Edit
                                                </button>{" "}
                                                <button
                                                    onClick={() => handleDelete(item._id)}
                                                    className="tw-bg-red-500 hover:tw-bg-red-700 tw-text-white tw-font-bold tw-px-4 tw-rounded focus:tw-outline-none focus:tw-shadow-outline"
                                                >
                                                    Delete
                                                </button>
                                            </div>
