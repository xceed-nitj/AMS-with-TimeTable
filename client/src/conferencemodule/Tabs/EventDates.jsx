        ...
        <main className='tw-py-10 tw-bg-gray-100 lg:tw-pl-72 tw-min-h-screen'>
            <div className='tw-px-4 sm:tw-px-6 lg:tw-px-8'>
                <form className="tw-bg-blue-100 tw-shadow-md tw-rounded tw-px-8 tw-pt-6 tw-pb-8 tw-m-10 " autoComplete="off" onSubmit={handleSubmit}>
                    <div className="tw-text-blue-700 tw-text-[28px] tw-font-serif tw-mx-auto tw-my-auto tw-grid tw-place-content-center" >Add New EventDate</div>
                    ...
                    <label className="tw-block tw-text-gray-700 tw-text-lg tw-ml-1 tw-font-bold ">Date</label>
                    <input type="datetime-local" name="date" value={date} onChange={handleChange}
                        className="tw-shadow tw-appearance-none tw-border tw-rounded tw-w-full tw-py-1 tw-mb-2 tw-px-3 tw-text-blue-700   tw-leading-tight    tw-focus:outline-none tw-focus:shadow-outline" />

                    <label className="tw-block tw-text-gray-700 tw-text-lg tw-ml-1 tw-font-bold">Is Date Extended ?</label>
                    ...
                    <label className="tw-block tw-text-gray-700 tw-text-lg tw-ml-1 tw-font-bold " >New Dates</label> <input type="datetime-local" name="newDate" value={newDate} onChange={handleChange}
                        className="tw-shadow tw-appearance-none tw-border tw-rounded tw-w-full tw-py-1 tw-mb-2 tw-px-3 tw-text-blue-700   tw-leading-tight    tw-focus:outline-none tw-focus:shadow-outline" />
                    <label className="tw-block tw-text-gray-700 tw-text-lg tw-ml-1 tw-font-bold">Featured</label>
                ...
                <div className="tw-shadow-md   tw-m-10 ali">
                    <div className="tw-text-black-700 tw-text-[28px] tw-font-serif tw-mx-auto tw-my-auto tw-grid tw-place-content-center" >Event Dates</div>
                                ...
                                {data.length > 0 ? data.map((item, index) => (
                                    <tr key={index} className="tw-border-[1px] tw-font-serif tw-border-blue-500">
                                        ...
                                        <td className="tw-p-1 tw-text-center  tw-flex tw-justify-evenly">
                                            <button onClick={() => { handleEdit(item._id); setEditID(item._id); }} className="tw-bg-yellow-500 tw-hover:bg-yellow-700 tw-text-white tw-font-bold tw-px-4 tw-mx-2 tw-rounded tw-focus:outline-none tw-focus:shadow-outline"> Edit </button>{" "}
