            ...
            <div className='tw-px-2 md:tw-px-4 lg:tw-px-8'>
                <form className="tw-bg-blue-100 tw-shadow-md tw-rounded tw-px-4 md:tw-px-8 tw-pt-6 tw-pb-8 tw-m-4 tw-mt-10 md:tw-m-10" autoComplete="off" onSubmit={handleSubmit}>
                    ...
                    <div className="tw-flex tw-justify-evenly">
                        ...
                        <button type="submit" onClick={() => { handleUpdate() }} className="tw-bg-blue-500 tw-hover:bg-blue-700 tw-text-white tw-font-bold tw-py-2 tw-px-4 tw-rounded focus:tw-:outline-none focus:tw-:shadow-outline">Update</button>
                    </div>
                </form>
