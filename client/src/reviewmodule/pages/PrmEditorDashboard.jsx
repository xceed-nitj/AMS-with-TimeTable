...
import { Box, Button, Grid, GridItem, Text, Icon,useBreakpointValue,} from '@chakra-ui/react';
...
const PrmEditorDashboard = () => {
  ...
  return (
    <Box bg="white" color="white" p={0} minHeight="100vh">
      <Container maxW="95vw">
        <Header title="Welcome to the Editor Dashboard" />
        <Text fontSize="xl" align="center" mb={4}>
          {event}
        </Text>
        <Grid templateColumns={`repeat(${breakpoints}, 1fr)`} gap={2} mb={2}>
          <Button
            width="100%"
            maxW="300px"
            height="50px"
        ...
        <Grid templateColumns={`repeat(${breakpoints}, 1fr)`} gap={6}>
          <GridItem>
            <Box height={{ base: '250px', md: '350px' }} bg="gray.800" borderRadius="lg" p={4}>
