...
function Subject() {
  ...
  return (
    <div>
              ...
              <td>
                {editRowId === row._id ? (
                  <Input
                    ...
                    onChange={(e) =>
                      setEditedData({ ...editedData, subCode: e.target.value })
                    }
                  />
                ) : (
                  row.subCode
              ...
              <td>
                {editRowId === row._id ? (
                  <Input
                    ...
                    onChange={(e) =>
                      setEditedData({ ...editedData, subName: e.target.value })
                    }
                  />
                ) : (
                  row.subName
              ...
              <td>
                {editRowId === row._id ? (
                  <Input
                    ...
                    onChange={(e) =>
                      setEditedData({ ...editedData, credits: e.target.value })
                    }
                  />
                ) : (
                  row.credits
      ...
      <h2>Add Subject</h2>
      <Grid mx={10} templateColumns={'repeat(2,1fr)'} gap={5} maxW={'lg'}>
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setEditedSData({ ...editedSData, abbreviation: e.target.value })
            }
          />
        </div>
        <div>
