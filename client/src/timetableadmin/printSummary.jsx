    ...
    <div>
      ...
      <Container maxW='4xl'>
        ...
        <Button
          ...
          variant="solid"
        >
          Download All Semesters Separate
        </Button>
        ...
        <Button
          ...
          variant="solid"
        >
          Download All Faculty Time Table separate
        </Button>
        ...
        <Button
          ...
          variant="solid"
        >
          Download All Faculty Time Table Merged
        </Button>
        ...
        <div className="message">
          ...
          {downloadType === 'facultyMerged' &&
            initiateStatus === 'startingMerged' && (
              <p className={initiateStatus === 'startingMerged' ? 'bold-message' : ''}>
                Initiating download. It may take while! Sit back and relax!
              </p>
            )}

          {downloadType === 'facultyMerged' &&
            slotStatus === 'fetchingSlotDataMerged' && (
              <p className={slotStatus === 'fetchingSlotDataMerged' ? 'bold-message' : ''}>
                Fetching slot data...
              </p>
            )}

          {downloadType === 'facultyMerged' &&
            summaryStatus === 'fetchingSummaryDataMerged' && (
              <p className={summaryStatus === 'fetchingSummaryDataMerged' ? 'bold-message' : ''}>
                Fetching summary data...
              </p>
            )}
          {downloadType === 'facultyMerged' &&
            noteStatus === 'fetchingNotesMerged' && (
              <p className={noteStatus === 'fetchingNotesMerged' ? 'bold-message' : ''}>
                Fetching notes...
              </p>
            )}
          {downloadType === 'facultyMerged' &&
            headerStatus === 'fetchingHeadersFootersMerged' && (
              <p className={headerStatus === 'fetchingHeadersFootersMerged' ? 'bold-message' : ''}>
                Fetching headers and footers...
              </p>
            )}
          {downloadType === 'facultyMerged' &&
            prepareStatus === 'preparingDownloadMerged' && (
              <p className={prepareStatus === 'preparingDownloadMerged' ? 'bold-message' : ''}>
                Preparing download...
              </p>
            )}
          {downloadType === 'facultyMerged' &&
            startStatus === 'downloadStartedMerged' && (
              <p className={startStatus === 'downloadStartedMerged' ? 'bold-message' : ''}>
                Download in progress. Last few miles to go...
              </p>
            )}
          {downloadType === 'facultyMerged' &&
            completeStatus === 'downloadCompletedMerged' && (
              <p style={{ fontWeight: 'bold', color: 'green' }}>
                Download Completed.
              </p>
            )}
        ...
        <Button
          ...
          variant="solid"
        >
          Download All Room Time Table Separate
        </Button>
        ...
        <Button
          ...
          variant="solid"
        >
          Download All Room Time Table Merged
        </Button>
