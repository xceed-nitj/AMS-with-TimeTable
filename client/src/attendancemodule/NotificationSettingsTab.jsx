    ...
    >
      <style>{`
        ...
        .ns-role-table tbody tr:hover {
          background: ${T.surfaceAlt || 'rgba(0,0,0,0.015)'};
        }
        .ns-role-table td {
          padding: 14px 8px;
        ...
        .ns-alert-checkbox-wrap:hover {
          background: ${T.accentDim || 'rgba(99,102,241,0.08)'};
        }
        .ns-role-table input[type=checkbox] {
          width: 17px; height: 17px; cursor: pointer;
          accent-color: ${T.accent};
        }
        .ns-role-table input[type=checkbox]:disabled {
          cursor: not-allowed;
        }
      ...
      <div className="ns-card">
        ...
        <div className="ns-card-body">
          ...
          >
            Check which alert types each role should receive. Recipients inherit
            their role's settings.
          </p>
            ...
            <table className="ns-role-table">
              ...
              <tbody>
                {ROLES.map((r) => {
                  ...
                  return (
                    <tr key={r.value} style={{ opacity: isUpdating ? 0.5 : 1 }}>
                      <td>
                      ...
                      {ALERT_TYPES.map((at) => {
                        ...
                        return (
                          <td key={at.key}>
                            <label className="ns-alert-checkbox-wrap">
                              <input
                                type="checkbox"
                                checked={checked}
                                disabled={isUpdating}
                                onChange={() =>
                                  handleRoleAlertToggle(
                                    r.value,
                                    at.key,
                                    checked,
                                  )
